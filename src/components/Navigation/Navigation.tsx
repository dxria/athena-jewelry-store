    ...
    return (
        <nav>
            <div className="w-screen py-6 px-5 lg:px-64 flex justify-center space-x-20 lg:space-x-40 shadow-md">
                ...
                <span className="flex items-center text-3xl font-dmserifdisplay font-semibold text-rich-bordeaux">
                    ATHENA
                </span>
                ...
                <ul className="flex items-center space-x-1">
                    <li className="font-raleway font-semibold">
                        {" "}
                        <FontAwesomeIcon
                            className="p-1"
                ...
                <button className="space-y-1 group lg:hidden">
                    ...
                    <ul className="bg-[#FFF] w-screen pb-10 absolute -top-full group-focus:top-0 right-0 duration-150 flex flex-col space-y-3 justify-end">
                        ...
                        <li className="font-raleway font-semibold flex justify-center w-full py-4 hover:bg-grey-rose hover:text-[#FFF]">
                            Home
                        </li>
                        <li className="font-raleway font-semibold flex justify-center w-full py-4 hover:bg-grey-rose hover:text-[#FFF]">
                            Shop
